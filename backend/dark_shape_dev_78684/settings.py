"""
Django settings for dark_shape_dev_78684 project.
...
ROOT_URLCONF = 'dark_shape_dev_78684.urls'
...
WSGI_APPLICATION = 'dark_shape_dev_78684.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "dark_shape_dev_78684 API",
    "DESCRIPTION": "API documentation for dark_shape_dev_78684 App",
    "VERSION": "v1",
}
